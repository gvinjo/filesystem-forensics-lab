...
| Calculated SHA-256 after examination | |
...
|---|---|---|---|---|---|
| 33| --- | 111| Thu Aug 27 21:05:21 2026| | |
...
|---|---|---|---|---|---|
| 33| debugfs -R "dump <33> recovered.txt" evidence/fin-ws-17.img| filesystem-forensics-phase-2/recovered/recovered.txt| 111 bytes| a2c64a64d7892041df8f3755dcc9e1075497335622aafb4374bf7d6dc2ee6393  ../filesystem-forensics-phase-2/recovered/recovered.txt| partial|
...
|---|---|---|
| | Initial image hash verification | |
| | Listed deleted inodes | |
| | Inspected candidate metadata | |
| | Recovered candidate to a separate directory | |
| | Calculated recovered-file hash | |
| | Final image hash verification | |
...
Evidence image unchanged: Yes / No / Not verified  
Recovery outputs saved to:  
Key limitations: