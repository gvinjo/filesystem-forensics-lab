...
This repository documents a two-phase synthetic filesystem-forensics investigation. Phase 1 covers evidence integrity, filesystem profiling, triage, and timeline construction. Phase 2 covers deleted-inode examination and file recovery.

> **Disclaimer:** This is a synthetic educational DFIR case. All users, systems, files, organizations, and events are fictional. No real personal or corporate information is included.

## Repository contents

- `evidence/` — original read-only filesystem image and its supplied SHA-256 digest
- `phase-1/report.md` — initial triage, timeline, assessment, and examination log
- `phase-1/tool-notes.md` — safe read-only command examples
- `phase-2/report.md` — deleted-file discovery, recovery, and assessment
- `phase-2/recovered/` — recovered artifact and its SHA-256 digest
...
The completed Phase 1 report is in `phase-1/report.md`. Deleted-file recovery is documented separately in `phase-2/report.md`.
